...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE books SET b_name=%s, b_author=%s, b_img=%s WHERE id=%s",
  ...
  $updateGoTo = "loginadminuser-master/search.php";
  if (isset($_SERVER['QUERY_STRING'])) {
