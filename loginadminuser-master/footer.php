            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <div class="single-footer-widget footer_1">
                        <a href="user_page.php"> <img src="img-books/005.jpg" alt=""> </a>
                        <p>Order matters, trust us. What product would you like? Here there is everything you want.</p>
                ...
                <div class="col-sm-6 col-md-6 col-xl-4">
                    <div class="single-footer-widget footer_2">
                        <h4>Trust us</h4>
                        <p>We have updated products for you to buy everyday. Fast delivery Safety guarantee.
                        </p>
                        <form action="#">
